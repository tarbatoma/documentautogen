/*
  # Add Global Invoice Template

  1. Changes
    - Add global invoice template if it doesn't exist
    - Update template if it already exists
    - Set up template structure with automatic calculations
    - Include all necessary fields for a professional invoice
...
BEGIN
  UPDATE templates
  SET
    description = 'Template standard pentru facturi cu calcul automat TVA și total',
    category = 'factura',
